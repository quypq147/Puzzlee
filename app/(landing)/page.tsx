      ...
      <main className="flex-1">
        ...
        <section className="mx-auto flex max-w-6xl flex-col items-center gap-10 px-4 py-16 md:flex-row md:py-20">
          ...
          <div className="flex-1 space-y-6 text-center md:text-left">
            ...
            <h1 className="text-4xl font-bold tracking-tight md:text-5xl">
              Ứng dụng Hỏi Đáp{" "}
              <span className="text-primary">thời gian thực</span> cho lớp học &
              sự kiện trực tuyến.
            </h1>
            ...
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground md:mx-0">
              ...
              ngay lập tức. Giảng viên & MC dễ dàng quản lý nội dung, chọn câu
              hỏi hay và giữ nhịp tương tác.
            </p>
            ...
            <div className="flex flex-col items-center gap-3 md:flex-row md:items-stretch">
              ...
              <Link href="/event/join" className="w-full md:w-auto">
            ...
            <Card className="mx-auto w-full max-w-md bg-background/80 backdrop-blur">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3 text-sm">
                  <MockQuestionRow
                    author="Sinh viên 1"
                    content="Làm sao tối ưu performance cho ứng dụng Next.js real-time?"
                    votes={23}
                    highlighted
                  />
                  <MockQuestionRow
                    author="Sinh viên 2"
                    content="Khác nhau giữa Server Actions và API Route là gì ạ?"
                    votes={15}
                  />
                  <MockQuestionRow
                    author="Khách tham dự"
                    content="Có thể dùng Puzzlee cho hội thảo offline không?"
                    votes={9}
                  />
                </div>
        ...
        <section id="features" className="mx-auto max-w-6xl px-4 pb-16">
          <div className="mb-8 text-center">
            <h2 className="text-2xl font-semibold tracking-tight md:text-3xl">
              Thiết kế cho lớp học, workshop & sự kiện đông người
            </h2>
            <p className="mt-2 text-muted-foreground">
              Các tính năng tập trung vào việc quản lý câu hỏi hiệu quả, tránh
              trùng lặp, hạn chế spam và giữ trải nghiệm mượt mà.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <FeatureCard
              ...
              title="Q&A real-time"
              description="Câu hỏi xuất hiện ngay khi gửi, được sắp xếp theo lượt bình chọn."
            />
            <FeatureCard
              icon={<Users className="h-5 w-5" />}
              title="Vai trò & phân quyền"
              description="Host, Moderator và Người tham gia với quyền hạn rõ ràng."
            />
            <FeatureCard
              icon={<Zap className="h-5 w-5" />}
              title="Live moderation"
              description="Duyệt, ẩn, highlight câu hỏi chỉ với một cú click."
            />
            <FeatureCard
              icon={<BarChart3 className="h-5 w-5" />}
              title="Thống kê & báo cáo"
              description="Theo dõi mức độ tương tác, số câu hỏi, lượt vote theo sự kiện."
            />
          </div>
        </section>
        ...
        <section className="mx-auto max-w-6xl px-4 py-20 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Tham gia hàng ngàn người dùng đang sử dụng Puzzlee để tạo những cuộc
            thảo luận tuyệt vời
          </p>
          <Link href="/register">
