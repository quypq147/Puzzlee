  ...
  return (
    <div className="min-h-screen w-full bg-slate-50 text-slate-900" suppressHydrationWarning>
      ...
      <div className="flex md:hidden items-center justify-between px-4 py-3 border-b bg-white">
        <div className="font-semibold">Tổ chức của tôi</div>
        <MobileNav />
      </div>

      <div className="flex">
        {/* Sidebar - hidden on mobile */}
        <aside className="hidden md:flex md:fixed md:inset-y-0 md:left-0 md:w-64 flex-col bg-slate-900 text-slate-100 border-r border-slate-800">
          <div className="h-14 flex items-center px-4 border-b border-slate-800">
            <Link href="/dashboard" className="font-semibold tracking-tight">Tổ chức của tôi</Link>
          </div>
